...
/*breadcrumb */
require get_template_directory().'/inc/customizer/theme-option/section-priority.php';

/*loading-screen */
require get_template_directory().'/inc/customizer/theme-option/loading-screen.php';

/*loading-screen */
require get_template_directory().'/inc/customizer/theme-option/full-page.php';
