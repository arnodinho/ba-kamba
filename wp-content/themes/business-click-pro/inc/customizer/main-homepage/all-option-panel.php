...
/*our-partner*/
require get_template_directory().'/inc/customizer/main-homepage/our-partner.php';


/*our-team*/
require get_template_directory().'/inc/customizer/main-homepage/our-team.php';

/*portfolio us*/
require get_template_directory().'/inc/customizer/main-homepage/portfolio.php';

/*Short code1*/
require get_template_directory().'/inc/customizer/main-homepage/short-code1.php';

/*short code2*/
require get_template_directory().'/inc/customizer/main-homepage/short-code2.php';
