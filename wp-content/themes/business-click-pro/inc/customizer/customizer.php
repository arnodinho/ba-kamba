...
require get_template_directory()  .'/inc/customizer/Important-links/important-links.php';
...
$business_click_settings_controls['business-click-customizer-reset-settings'] =
    array(
        ...
        'control' => array(
            ...
            'description'           =>  esc_html__( 'Caution: This will reset all customizer settings to default. Click the Publish button and Reload the page to view the changes.', 'business-click' ),
 ...
 */
function business_click_panels_js() {
    wp_enqueue_script( 'business_click-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
add_action( 'customize_controls_enqueue_scripts', 'business_click_panels_js' );
