...
$config = array(
	...
	'welcome_title' => sprintf( esc_html__( 'Welcome to %s Pro - ', 'business-click' ), 'Business-Click' ),
	...
	'quick_links' => array(
		...
		'pro_url' => array(
			'text' => esc_html__( 'Our Pro Demos','business-click' ),
	...
	'getting_started' => array(
		...
		array(
			'title'        			=> esc_html__( 'Pro Demos', 'business-click' ),
