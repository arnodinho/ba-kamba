...
function rise_blocks_custom_fields_checkbox_sanitizer( $value ){
...
class Helper{
	...
	public function sanitize( $field ){
		...
		switch( $field[ 'type' ] ){
			...
			case 'checkbox':
				$fn = 'rise_blocks_custom_fields_checkbox_sanitizer';
    		break;
		...
		$fn = apply_filters( 'rise_blocks_custom_fields_sanitizer', $fn, $field );
