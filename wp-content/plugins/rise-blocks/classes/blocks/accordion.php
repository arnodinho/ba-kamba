		...
		*/
		public function prepare_scripts_styles(){
			...
			foreach( $blocks as $block ){
                ...
                $attrs = $block[ 'attrs' ];
                ?>
            	jQuery( "#<?php echo esc_attr( $attrs[ 'block_id' ] ); ?>" ).accordion({
            	    active: false,
            	    collapsible: true,
            	    heightStyle: "content",
            	    ...
            	    activate: function( event, ui ){
            	    	...
            	    	if( jQuery('.news2-init').length > 0 ){
            	    		jQuery('.news2-init').slick( 'refresh' );
            	    	}

            	    	if( jQuery('.rise-blocks-banner-slider-init').length > 0 ){
            	    		jQuery('.rise-blocks-banner-slider-init').slick( 'refresh' );
            	    	}
