    ...
    <div class="rb-row rb-px-6 rb-py-6 rb-align-items-center change-order">
        ...
        <div class="rb-col-6 order-1">
            <div class="rb-intro-head">
                ...
                <h1 class="rb-heading rb-heading-small"> Guten Biz </h1>
                ...
                <div class="rb-btn-wrap with-icon">
                    <a href="https://downloads.wordpress.org/theme/gutenbiz.latest-stable.zip" target="_blank" class="rb-icon-dnl"> Download Now </a>
                    &nbsp;
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=rise-blocks-marketplace' ) ) ?>" target="_blank" class="rb-icon-dnl marketplace"> Go To Marketplace </a>
                </div>
            </div>
        </div>
